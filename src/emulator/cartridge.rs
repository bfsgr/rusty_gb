...
impl Cartridge {
    ...
    pub fn read_byte(&self, addr: u16) -> Response {
        if addr < 256 && self.bios_control == 0 {
            Response::Byte( BIOS[addr as usize] )
        } else {
...
const BIOS: [u8; 256] = [0x31, 0xFE, 0xFF, 0x21, 0xFF, 0x9F, 0xAF, 0x32, 0xCB, 0x7C, 0x20, 0xFA, 0x0E, 0x11, 0x21, 0x26,
...
0x43, 0x05, 0x7B, 0xFE, 0xD8, 0x28, 0x04, 0x1A, 0xE0, 0x47, 0x13, 0x0E, 0x1E, 0xCD, 0xA7, 0x00,
0xAF, 0x90, 0xE0, 0x43, 0x05, 0x0E, 0x1E, 0xCD, 0xA7, 0x00, 0xAF, 0xB0, 0x20, 0xE0, 0xE0, 0x43,
0x3E, 0x83, 0xCD, 0x9F, 0x00, 0x0E, 0x1E, 0xCD, 0xA7, 0x00, 0x3E, 0xC1, 0xCD, 0x9F, 0x00, 0x11,
0xF2, 0x01, 0xF0, 0x44, 0xFE, 0x90, 0x20, 0xFA, 0x1B, 0x7A, 0xB3, 0x20, 0xF5, 0x18, 0x49, 0x0E,
...
0x4D, 0x47, 0x20, 0x76, 0x31, 0x2E, 0x31, 0x00, 0x3E, 0xFF, 0xC6, 0x01, 0x0B, 0x1E, 0xD8, 0x21,
